...
If you experienced problems after updating the plugin, report it to us in the [GitHub issues](https://github.com/BX-Team/Nexus/issues) page or in our [Discord server](https://discord.gg/qNyybSSPm5).
