...
const LINKS = {
  nav: [
    ...
    { href: 'https://docs.bxteam.org', label: 'Docs', external: true },
    { href: 'https://status.bxteam.org', label: 'Status', external: true },
    { href: 'https://repo.bxteam.org', label: 'Maven Repo', external: true },
  ],
  social: [
    {
